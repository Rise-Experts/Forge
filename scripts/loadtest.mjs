...
const PG = arg("pg", process.env.FORGE_TEST_PG_URL ?? process.env.FORGE_TEST_PG_URL);
if (!PG) {
  console.error("✗ --pg <url> (or FORGE_TEST_PG_URL) is required: this harness needs a real PostgreSQL server.");
