...
Retinue's Supabase adapter uses the PostgreSQL persistence contracts with Supabase row-level security. Use it when Supabase is already your managed Postgres environment and you want database-enforced tenant boundaries.
