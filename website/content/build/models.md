---
title: Models
description: Configure model providers and model roles for a Forge agent.
---

# Models

An agent asks for a model **role** such as `fast` or `smart`; Forge resolves that role to a configured provider model. This keeps agent behavior independent of one provider or model identifier.
