 ...
 *
 * Executor: `FORGE_TEST_PG_URL` points at a real PostgreSQL server (CI, so server-only behaviour
 ...
 *
 * Run against pgvector with `FORGE_TEST_PG_URL` pointing at a Postgres that has it.
 */
