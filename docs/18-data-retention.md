...
```ts
import { createPostgresRunEventPruner } from "@forge/agentkit/adapters/postgres";
import { cutoffFor, drain, DEFAULT_RUN_EVENT_RETENTION_DAYS } from "@forge/agentkit/observability";
