...
[![npm](https://img.shields.io/npm/v/@forge/tools-search)](https://www.npmjs.com/package/@forge/tools-search)
[![licence](https://img.shields.io/npm/l/@forge/tools-search)](https://github.com/Rise-Experts/Forge/blob/main/LICENSE)
...
That is the point. `web_search` exists in `@forge/agentkit` and takes its provider as configuration, so five
...
import { tavilySearch } from "@forge/tools-search";
